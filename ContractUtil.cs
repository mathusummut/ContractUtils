...
namespace ContractUtils {
	...
	public static class ContractUtil {
		...
		public static CompiledContract GetCompiledContractFromFile(string jsonPath) {
			return GetCompiledContract(File.ReadAllText(jsonPath));
		}
		...
		public static CompiledContract GetCompiledContract(string jsonString) {
		...
		/// <param name="retryCount">The maximum number of retries if an error occurs</param>
		/// <param name="constructorParams">The values to pass to the contract constructor</param>
		public static Task<DeployedContract> DeployContractFromFile(string jsonPath, Wallet wallet, HexBigInteger gas, HexBigInteger gasPrice, HexBigInteger value, int retryCount = 10, params object[] constructorParams) {
			return DeployContract(GetCompiledContractFromFile(jsonPath), wallet, gas, gasPrice, value, retryCount, constructorParams);
		}
		...
		/// <param name="retryCount">The maximum number of retries if an error occurs</param>
		/// <param name="constructorParams">The values to pass to the contract constructor</param>
		public static Task<DeployedContract> DeployContract(string jsonString, Wallet wallet, HexBigInteger gas, HexBigInteger gasPrice, HexBigInteger value, int retryCount = 10, params object[] constructorParams) {
			return DeployContract(GetCompiledContract(jsonString), wallet, gas, gasPrice, value, retryCount, constructorParams);
		}
		...
		/// <param name="wallet">The wallet address of the contract owner</param>
		/// <param name="constructorParams">The values to pass to the contract constructor</param>
		public static Task<DeployedContract> DeployContractFromFile(string jsonFile, Wallet wallet, params object[] constructorParams) {
			return DeployContractFromFile(jsonFile, wallet, ConfigParams.DefaultGas, ConfigParams.DefaultGasPrice, ConfigParams.DefaultValue, 10, constructorParams);
		}
		...
		/// <param name="wallet">The wallet address of the contract owner</param>
		/// <param name="constructorParams">The values to pass to the contract constructor</param>
		public static Task<DeployedContract> DeployContract(string jsonString, Wallet wallet, params object[] constructorParams) {
			return DeployContract(jsonString, wallet, ConfigParams.DefaultGas, ConfigParams.DefaultGasPrice, ConfigParams.DefaultValue, 10, constructorParams);
		}
